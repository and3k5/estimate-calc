export class Notation {
    ...
    constructor(notation: string, singleName: string, multiName: string, propertyName: string, order: number, ms: number, relativeAmount: number, visibleByDefault: boolean) {
